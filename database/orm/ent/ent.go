...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			issueforent.Table:      issueforent.ValidColumn,
			repositoryforent.Table: repositoryforent.ValidColumn,
			table01forent.Table:    table01forent.ValidColumn,
			userforent.Table:       userforent.ValidColumn,
		})
	})
