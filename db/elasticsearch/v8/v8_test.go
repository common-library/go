...
func initialize(elasticsearch *v8.Elasticsearch, addresses []string) error {
	return elasticsearch.Initialize(addresses, timeout, "", "", "", "", "", []byte(""))
}

func exists(elasticsearch *v8.Elasticsearch) error {
...
func deletes(elasticsearch *v8.Elasticsearch) error {
...
func existsTemplate(elasticsearch *v8.Elasticsearch) error {
	err := initialize(elasticsearch, addresses)
	if err != nil {
		return err
	}
...
func deletesTemplate(elasticsearch *v8.Elasticsearch) error {
...
func TestInitialize(t *testing.T) {
	elasticsearch := v8.Elasticsearch{}
